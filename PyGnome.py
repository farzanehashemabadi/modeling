...
def run (position, sub, startday, spilldur, season, spill_num):
    ...
    #    model.outputters += NetCDFOutput(netcdf_output_file, which_data='all',
     #                                    output_timestep=timedelta(hours=24))
        ...
        dir_name = os.path.join (base_dir, season, str(position), "Result {}_{}".format(spill_num, position))
...
#senarios (positions1, substances1, str_days, str_times, spill_dur, 'Winter')
#senarios (positions2, substances2, str_days, str_times, spill_dur, 'Winter')



#senarios (positions1, substances1, str_days, str_times, spill_dur, 'Summer')
#senarios (positions2, substances2, str_days, str_times, spill_dur, 'Summer')
