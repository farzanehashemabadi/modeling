...
def run (position, sub, startday, spilldur, season, spill_num):
    ...
    # !!!!!!!Item should chenged!!!!!!!!!
    wind = Wind (filename= os.path.join(base_dir, 'Summwind.txt'))

    waves = Waves ()


    def make_model(Ropme):
        ...
        wind_file = get_datafile(os.path.join(base_dir, 'SummECMWF.nc'))
        ...
        curr_file = get_datafile(os.path.join(base_dir, 'SummCurrent.nc'))
...
if __name__ == "__main__":
    ...
    # if run_id == 1:
    #     args = (positions1, substances1, str_days, str_times, spill_dur, 'Winter', 1)
    # elif run_id == 2:
    #     args = (positions2, substances2, str_days, str_times, spill_dur, 'Winter', 801)
    # else:
        
    if run_id == 3:
        args = (positions1, substances1, str_days, str_times, spill_dur, 'Summer', 1601)
    elif run_id == 4:
        args = (positions2, substances2, str_days, str_times, spill_dur, 'Summer', 2401)
    else:
        args = None
