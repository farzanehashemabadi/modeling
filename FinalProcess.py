...
src_dirs = [os.path.join(base_dir, seasons, 'Result {}_{}'.format(spill_num, positions)) for spill_num, positions in zip(range(1,101),positions)]
...
for src_dir in src_dirs:
    ...
    for fc in fclist:
        ...
        for index, cfs in enumerate(clippers):
            ...
            result_file = os.path.join(src_dir, "Risk.txt")
