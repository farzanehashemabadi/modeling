...
def run (position, sub, startday, spilldur, season, spill_num):
    ...
    # !!!!!!!Item should chenged!!!!!!!!!
    wind = Wind (filename= os.path.join(base_dir, 'Wintwind.txt'))
    ...
    def make_model(Ropme):
        ...
        wind_file = get_datafile(os.path.join(base_dir, 'WintECMWF.nc'))
        ...
        curr_file = get_datafile(os.path.join(base_dir, 'WintCurrent.nc'))
