...
def Process(season, position_id):
    print ('start process:')
    ...
    src_dirs = [os.path.join(base_dir, season, str(position)) for position in position_id]
...
if __name__ == "__main__":
    ...
    if run_id == 1:
        args = ('Winter', positions[0])

    elif run_id == 2:
        args = ('Winter', positions[1])
    
    if run_id == 3:
        args = ('Summer', positions[0])
    elif run_id == 4:
        args = ('Summer', positions[1])
